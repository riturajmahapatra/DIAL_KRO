      ...
      <nav className="mx-4 my-2 flex flex-col md:mx-8 md:flex-row lg:mx-16">
        ...
        <div className=" flex flex-1 items-center justify-end gap-2 md:mt-0 md:gap-10">
          <ul className="flex flex-col gap-2 max-lg:hidden md:flex-row md:items-center md:gap-4">
            <Button className="bg-white text-[12px] text-[#036c93] hover:bg-white hover:text-blue-300">
              SERVICES
            </Button>

            <Link href={'/registration'}>
              <Button className="bg-white text-[14px] text-xs capitalize  text-[#036c93] hover:bg-white hover:text-blue-300">
                ADD BUSINESS
              </Button>
            </Link>
            <Link href={'/Aboutus'}>
              <Button className="bg-white text-[14px] text-xs text-[#036c93] hover:bg-white hover:text-blue-300">
                ADVERTISE
              </Button>
            </Link>
            <UserMenu />
